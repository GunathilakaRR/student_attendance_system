                        ...
                        <div class="row">
                            <div class="col-md-3 border-right">
                                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                    ...
                                    @if ($students->image)
                                        <img class="rounded-circle mt-5" width="150px" src="{{ asset('storage/' . $students->image) }}" alt="Profile Picture">
                                    @else
                                        <img class="rounded-circle mt-5" width="150px" src="{{ asset('images/default_profile.jpg') }}" alt="Default Profile Picture" >
                                    @endif

                                    <span class="font-weight-bold">{{ $students->name1 }}</span>
                                    <span class="text-black-50">{{ $students->registration_number }}</span>
                                </div>
                            </div>
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6"><label class="labels">Registration No.</label><input
                                                    ...
                                                    value="{{ $students->registration_number }}"></div>
